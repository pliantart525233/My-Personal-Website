...
(function () {
    ...
    var t = this,
        ...
        e = function (t) {
            this.canvas = t.canvas,
                this.ctx = t;
            var i = function (t,
                i) { return t["offset" + i] ? t["offset" + i] : document.defaultView.getComputedStyle(t).getPropertyValue(i) },
                e = this.width = i(t.canvas,
                    "Width"),
                n = this.height = i(t.canvas,
                    "Height");
            t.canvas.width = e,
                t.canvas.height = n;
    ...
    var s = e.helpers = {},
        ...
        r = (s.where = function (t,
            i) {
            var e = [];
            return s.each(t,
                function (t) { i(t) && e.push(t) }),
                e
        },
            s.findNextWhere = function (t,
                i,
                e) {
                e || (e = -1);
                for (var s = e + 1;
            ...
            s.findPreviousWhere = function (t,
                i,
                e) {
                e || (e = t.length);
                for (var s = e - 1;
        ...
        y = (s.splineCurve = function (t,
            i,
            e,
            s) {
            var n = Math.sqrt(Math.pow(i.x - t.x,
                2) + Math.pow(i.y - t.y,
                    2)),
                o = Math.sqrt(Math.pow(e.x - i.x,
                    2) + Math.pow(e.y - i.y,
                        2)),
                a = s * n / (n + o),
                h = s * o / (n + o);
        ...
        C = (s.calculateScaleRange = function (t,
            i,
            e,
            s,
            n) {
            ...
            for (var c = Math.abs(l - r),
                u = y(c),
                d = Math.ceil(l / (1 * Math.pow(10,
                    u))) * Math.pow(10,
                        u),
                p = s ? 0 : Math.floor(r / (1 * Math.pow(10,
                    u))) * Math.pow(10,
                        u),
                f = d - p,
                v = Math.pow(10,
        ...
        w = (s.generateLabels = function (t,
            ...
            s.easingEffects = {
                ...
                easeInExpo: function (t) {
                    return 0 === t ? 1 : 1 * Math.pow(2,
                        10 * (t / 1 - 1))
                },
                easeOutExpo: function (t) {
                    return 1 === t ? 1 : 1 * (-Math.pow(2,
                        -10 * t / 1) + 1)
                },
                easeInOutExpo: function (t) {
                    return 0 === t ? 0 : 1 === t ? 1 : (t /= .5) < 1 ? .5 * Math.pow(2,
                        10 * (t - 1)) : .5 * (-Math.pow(2,
                            -10 * --t) + 2)
                },
                ...
                easeInOutElastic: function (t) {
                    ...
                    return 0 === t ? 0 : 2 == (t /= .5) ? 1 : (e || (e = .3 * 1.5),
                        s < Math.abs(1) ? (s = 1,
                            i = e / 4) : i = e / (2 * Math.PI) * Math.asin(1 / s),
                        1 > t ? -.5 * s * Math.pow(2,
                            10 * (t -= 1)) * Math.sin(2 * (1 * t - i) * Math.PI / e) : s * Math.pow(2,
                                -10 * (t -= 1)) * Math.sin(2 * (1 * t - i) * Math.PI / e) * .5 + 1)
                },
        ...
        L = (s.animationLoop = function (t,
            ...
            s.addEvent = function (t,
                i,
                e) {
                t.addEventListener ? t.addEventListener(i,
                    e) : t.attachEvent ? t.attachEvent("on" + i,
                        e) : t["on" + i] = e
            }),
        k = s.removeEvent = function (t,
            i,
            e) {
            t.removeEventListener ? t.removeEventListener(i,
                e,
                !1) : t.detachEvent ? t.detachEvent("on" + i,
                    e) : t["on" + i] = c
        },
        F = (s.bindEvents = function (t,
            i,
            e) {
            t.events || (t.events = {}),
                n(i,
        ...
        A = (s.getMaximumSize = s.getMaximumWidth,
            s.retinaScale = function (t) {
                ...
                window.devicePixelRatio && (i.canvas.style.width = e + "px",
                    ...
                    i.scale(window.devicePixelRatio,
        ...
        W = s.fontString = function (t,
            i,
            e) { return i + " " + t + "px " + e },
        z = s.longestText = function (t,
            i,
            e) {
            t.font = i;
            var s = 0;
        ...
        B = s.drawRoundedRectangle = function (t,
            i,
            e,
            s,
            n,
    ...
    e.instances = {},
        ...
        a(e.Type.prototype,
            {
                ...
                render: function (t) {
                    return t && this.reflow(),
                        this.options.animation && !t ? s.animationLoop(this.draw,
                ...
                generateLegend: function () {
                    return C(this.options.legendTemplate,
                        this)
                },
                destroy: function () {
                    this.clear(),
                    ...
                    if (o || i) {
                        if (this.activeElements = t,
                            ...
                            t.length > 0) if (this.datasets && this.datasets.length > 1) {
                                for (var a,
                                    h,
                                    r = this.datasets.length - 1;
                                    r >= 0 && (a = this.datasets[r].points || this.datasets[r].bars || this.datasets[r].segments,
                                        h = l(a,
                                            t[0]),
                                        -1 === h);
                                    r--);
                                        ...
                                        return s.each(this.datasets,
                                            ...
                                            s.each(a,
                                                function (t) {
                                                    l.push(t.x),
                                                        r.push(t.y),
                                                        c.push(s.template(this.options.multiTooltipTemplate,
                                                            t)),
                                                        u.push({
                                ...
                                function (t) {
                                    ...
                                    new e.Tooltip({
                                        ...
                                        cornerRadius: this.options.tooltipCornerRadius,
                                        text: C(this.options.tooltipTemplate,
                                            t),
                                        chart: this.chart,
                                        custom: this.options.customTooltips
                                    }).draw()
        ...
        a(e.Element.prototype,
            {
                ...
                restore: function (t) {
                    return t ? n(t,
                        function (t) { this[t] = this._saved[t] },
                        this) : a(this,
                            this._saved),
                        this
                },
                ...
                transition: function (t,
                    ...
                    return n(t,
                        function (t,
                            e) { this[e] = (t - this._saved[e]) * i + this._saved[e] },
                        this),
                        this
                },
        ...
        e.Rectangle = e.Element.extend({
            ...
            inRange: function (t,
                i) { return t >= this.x - this.width / 2 && t <= this.x + this.width / 2 && i >= this.y && i <= this.base }
        }),
        e.Tooltip = e.Element.extend({
            draw: function () {
                var t = this.chart.ctx;
                t.font = W(this.fontSize,
                    this.fontStyle,
                    this.fontFamily),
                    this.xAlign = "center",
                    this.yAlign = "above";
                ...
                if (t.fillStyle = this.fillColor,
                    this.custom) this.custom(this);
                else {
                    switch (this.yAlign) {
                        case "above": t.beginPath(),
                            t.moveTo(this.x,
                                this.y - i),
                            t.lineTo(this.x + this.caretHeight,
                            ...
                            t.fill();
                            break;
                        case "below": a = this.y + i + this.caretHeight,
                            t.beginPath(),
                            t.moveTo(this.x,
                                this.y + i),
                            t.lineTo(this.x + this.caretHeight,
                        ...
                        case "left": o = this.x - e + (this.cornerRadius + this.caretHeight);
                            break;
                        case "right": o = this.x - (this.cornerRadius + this.caretHeight)
                    }B(t,
                        o,
                        a,
                        e,
        ...
        e.MultiTooltip = e.Element.extend({
            initialize: function () {
                this.font = W(this.fontSize,
                    this.fontStyle,
                    this.fontFamily),
                    this.titleFont = W(this.titleFontSize,
                        this.titleFontStyle,
                        ...
                        s.each(this.labels,
                            function (i,
                                ...
                                t.fillStyle = this.textColor,
                                    ...
                                    t.fillRect(this.x + this.xPadding,
        ...
        e.Scale = e.Element.extend({
            ...
            buildYLabels: function () {
                ...
                for (var t = v(this.stepValue),
                    i = 0;
                    i <= this.steps;
                    i++)this.yLabels.push(C(this.templateString,
                        { value: (this.min + i * this.stepValue).toFixed(t) }));
                this.yLabelWidth = this.display && this.showLabels ? z(this.ctx,
                    this.font,
                    this.yLabels) : 0
            },
                ...
                if (this.xScalePaddingRight = s / 2 + 3,
                    ...
                    var n,
                        o = z(this.ctx,
                            ...
                            this.xLabels);
                    this.xLabelWidth = o;
                    for (var a = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6;
                        this.xLabelWidth > a && 0 === this.xLabelRotation || this.xLabelWidth > a && this.xLabelRotation <= 90 && this.xLabelRotation > 0;
            ...
            calculateX: function (t) {
                var i = (this.xLabelRotation > 0,
                    ...
                    e = i / Math.max(this.valuesCount - (this.offsetGridLines ? 0 : 1),
                        1),
        ...
        e.RadialScale = e.Element.extend({
            ...
            setScaleSize: function () {
                var t,
                    ...
                    p = this.width,
                    g = 0;
                for (this.ctx.font = W(this.pointLabelFontSize,
                    this.pointLabelFontStyle,
                    this.pointLabelFontFamily),
                    i = 0;
                    i < this.valuesCount;
                    i++)t = this.getPointPosition(i,
                        d),
                        e = this.ctx.measureText(C(this.templateString,
                            { value: this.labels[i] })).width + 5,
            ...
            draw: function () {
                if (this.display) {
                    ...
                    if (n(this.yLabels,
                        function (i,
                            ...
                            if (e > 0) {
                                var s,
                                    ...
                                    o = this.yCenter - n;
                                if (this.lineWidth > 0) if (t.strokeStyle = this.lineColor,
                                    t.lineWidth = this.lineWidth,
                                    this.lineArc) t.beginPath(),
                                        t.arc(this.xCenter,
                                            this.yCenter,
                                            n,
                                            0,
                                    ...
                                    if (t.font = W(this.fontSize,
                                        this.fontStyle,
                                        this.fontFamily),
                                        this.showLabelBackdrop) {
                                        var h = t.measureText(i).width;
                                        t.fillStyle = this.backdropColor,
                                            t.fillRect(this.xCenter - h / 2 - this.backdropPaddingX,
                        ...
                        for (var i = this.valuesCount - 1;
                            i >= 0;
                            i--) {
                            if (this.angleLineWidth > 0) {
                                var e = this.getPointPosition(i,
                                    this.calculateCenterOffset(this.max));
                                t.beginPath(),
                                    t.moveTo(this.xCenter,
                                        this.yCenter),
                                    t.lineTo(e.x,
                                        e.y),
                                    t.stroke(),
                            ...
                            t.font = W(this.pointLabelFontSize,
                                this.pointLabelFontStyle,
                                this.pointLabelFontFamily),
                ...
                return function () {
                    clearTimeout(t),
                        t = setTimeout(function () {
                            n(e.instances,
                                function (t) {
                                    t.options.responsive && t.resize(t.render,
                                        !0)
                                })
                        },
                            50)
        ...
        p ? define(function () { return e }) : "object" == typeof module && module.exports && (module.exports = e),
        t.Chart = e,
        ...
        i.Type.extend({
            ...
            initialize: function (t) {
                ...
                this.ScaleClass = i.Scale.extend({
                    ...
                    this.datasets = [],
                    this.options.showTooltips && e.bindEvents(this,
                        ...
                        e.extend(t,
                            {
                                ...
                                x: this.scale.calculateBarX(this.datasets.length,
                                    s,
                                    i),
            ...
            update: function () {
                this.scale.update(),
                    ...
                    this.eachBars(function (t) { t.save() }),
                    this.render()
            },
            eachBars: function (t) {
            ...
            getBarsAtEvent: function (t) {
                for (var i,
                    ...
                    o = function (t) { s.push(t.bars[i]) },
                    a = 0;
                    a < this.datasets.length;
                    a++)for (i = 0;
                        i < this.datasets[a].bars.length;
                        i++)if (this.datasets[a].bars[i].inRange(n.x,
                            n.y)) return e.each(this.datasets,
                                o),
                                s;
                return s
            },
            buildScale: function (t) {
                var i = this,
                    s = function () {
                        var t = [];
                        return i.eachBars(function (i) { t.push(i.value) }),
                            t
                    },
                    n = {
                        ...
                        xLabels: t,
                        font: e.fontString(this.options.scaleFontSize,
    ...
    function () {
        ...
        i.Type.extend({
                    ...
                    this.options.showTooltips && e.bindEvents(this,
                        ...
                        function (t) {
                            ...
                            e.each(this.segments,
                                function (t) { t.restore(["fillColor"]) }),
                                e.each(i,
                                    function (t) { t.fillColor = t.highlightColor }),
                                this.showTooltip(i)
                        }),
            ...
            calculateTotal: function (t) {
                this.total = 0,
                    e.each(t,
                        function (t) { this.total += Math.abs(t.value) },
                        this)
            },
            update: function () {
        ...
        i.Type.extend({
            ...
            initialize: function (t) {
                this.PointClass = i.Point.extend({
                    ...
                    inRange: function (t) {
                        return Math.pow(t - this.x,
                            2) < Math.pow(this.radius + this.hitDetectionRadius,
                                2)
                    }
                }),
                    this.datasets = [],
            ...
            update: function () {
                this.scale.update(),
                    ...
                    this.eachPoints(function (t) { t.save() }),
                    this.render()
            },
            ...
            buildScale: function (t) {
                var s = this,
                    n = function () {
                        var t = [];
                        return s.eachPoints(function (i) { t.push(i.value) }),
                            t
                    },
                    o = {
                        templateString: this.options.scaleLabel,
                            ...
                            e.each(t.points,
                                ...
                                this.options.bezierCurve && e.each(h,
                                    function (t,
                                        ...
                                        t.controlPoints = e.splineCurve(a(t,
                                            h,
                                            i),
                                            t,
                                            o(t,
                                ...
                                e.each(h,
                                    function (t,
                                        ...
                                        if (0 === i) s.moveTo(t.x,
                                            ...
                                            var e = a(t,
                                                h,
                                                i);
                                            s.bezierCurveTo(e.controlPoints.outer.x,
                                    ...
                                    this),
                                s.stroke(),
                                this.options.datasetFill && h.length > 0 && (s.lineTo(h[h.length - 1].x,
                                    this.scale.endPoint),
                                    s.lineTo(h[0].x,
                                        this.scale.endPoint),
    ...
    function () {
        ...
        i.Type.extend({
            ...
            updateScaleRange: function (t) {
                var i = [];
                e.each(t,
                    function (t) { i.push(t.value) });
                var s = this.options.scaleOverride ? {
                    steps: this.options.scaleSteps,
                    stepValue: this.options.scaleStepWidth,
                    min: this.options.scaleStartValue,
                    max: this.options.scaleStartValue + this.options.scaleSteps * this.options.scaleStepWidth
                } : e.calculateScaleRange(i,
                    e.min([this.chart.width,
                    this.chart.height]) / 2,
            ...
            reflow: function () {
                e.extend(this.SegmentArc.prototype,
                    ...
                    e.each(this.segments,
                        function (t) { t.update({ outerRadius: this.scale.calculateCenterOffset(t.value) }) },
                        this)
            },
            draw: function (t) {
                var i = t || 1;
